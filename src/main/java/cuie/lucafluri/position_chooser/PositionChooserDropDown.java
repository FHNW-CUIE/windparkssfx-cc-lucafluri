...
class PositionChooserDropDown extends VBox {
    ...
    private void initializeParts() {
        ...
        mapView.initialize(Configuration.builder().projection(Projection.WEB_MERCATOR).showZoomControls(false).build());
    ...
    private void setupEventHandlers() {
        ...
        mapView.initializedProperty()
                .addListener((observableValue, oldValue, newValue) -> mapView.addMarker(posMarker));
